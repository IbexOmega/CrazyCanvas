...
MainMenuGUIOld::MainMenuGUIOld(const LambdaEngine::String& xamlFile)
{
...
MainMenuGUIOld::~MainMenuGUIOld()
{
}

bool MainMenuGUIOld::ConnectEvent(BaseComponent* pSource, const char* pEvent, const char* pHandler)
{
...
void MainMenuGUIOld::OnButtonSingleplayerClick(BaseComponent* pSender, const RoutedEventArgs& args)
{
...
void MainMenuGUIOld::OnButtonMultiplayerClick(BaseComponent* pSender, const RoutedEventArgs& args)
{
	UNREFERENCED_VARIABLE(pSender);
	UNREFERENCED_VARIABLE(args);
...
void MainMenuGUIOld::OnButtonBenchmarkClick(Noesis::BaseComponent* pSender, const Noesis::RoutedEventArgs& args)
{
	UNREFERENCED_VARIABLE(pSender);
	UNREFERENCED_VARIABLE(args);
...
void MainMenuGUIOld::OnButtonSettingsClick(BaseComponent* pSender, const RoutedEventArgs& args)
{
	UNREFERENCED_VARIABLE(pSender);
	UNREFERENCED_VARIABLE(args);
...
void MainMenuGUIOld::OnButtonKeybindingsClick(BaseComponent* pSender, const RoutedEventArgs& args)
{
	UNREFERENCED_VARIABLE(pSender);
	UNREFERENCED_VARIABLE(args);
...
void MainMenuGUIOld::OnButtonApplyClick(BaseComponent* pSender, const RoutedEventArgs& args)
{
	UNREFERENCED_VARIABLE(pSender);
...
void MainMenuGUIOld::OnButtonBackClick(BaseComponent* pSender, const RoutedEventArgs& args)
{
	UNREFERENCED_VARIABLE(pSender);
	UNREFERENCED_VARIABLE(args);
...
void MainMenuGUIOld::OnButtonExitClick(BaseComponent* pSender, const RoutedEventArgs& args)
{
	UNREFERENCED_VARIABLE(pSender);
	UNREFERENCED_VARIABLE(args);
...
void MainMenuGUIOld::OnRayTracingChecked(BaseComponent* pSender, const RoutedEventArgs& args)
{
	UNREFERENCED_VARIABLE(pSender);
...
void MainMenuGUIOld::OnMeshShadersChecked(BaseComponent* pSender, const RoutedEventArgs& args)
{
	UNREFERENCED_VARIABLE(pSender);
...
void MainMenuGUIOld::OnVolumeSliderChanged(BaseComponent* pSender, const RoutedPropertyChangedEventArgs<float>& args)
{
	AudioAPI::GetDevice()->SetMasterVolume(args.newValue);
}

void MainMenuGUIOld::SetRenderStagesSleeping()
{
...
void MainMenuGUIOld::ToggleView(Noesis::FrameworkElement* element)
{
