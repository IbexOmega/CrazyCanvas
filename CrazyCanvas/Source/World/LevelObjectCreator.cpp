	...
	LambdaEngine::TArray<uint64>& saltUIDs)
{
	...
	const CharacterColliderCreateInfo colliderInfo =
	{
		...
		.CollisionMask	= (uint32)FCollisionGroup::COLLISION_GROUP_STATIC | (uint32)FCrazyCanvasCollisionGroup::COLLISION_GROUP_PLAYER | (uint32)FCrazyCanvasCollisionGroup::COLLISION_GROUP_FLAG
	};
