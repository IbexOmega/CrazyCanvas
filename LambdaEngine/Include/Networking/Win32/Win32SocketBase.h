...
namespace LambdaEngine
{
	...
	protected:
		...
		static void PrintLastError()
		{
			...
			case WSAENAMETOOLONG: message = "AnimationName too long. A name component or a name was too long."; break;
