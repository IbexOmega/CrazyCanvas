...
namespace LambdaEngine
{
	...
	*/
	enum EAction : uint8
	{
		...
		ACTION_MOVE_LEFT			= 4,
		ACTION_MOVE_WALK			= 5,
		ACTION_MOVE_SPRINT			= 6,
		ACTION_MOVE_CROUCH			= 7,
		ACTION_MOVE_JUMP			= 8,

		// Attack
		ACTION_ATTACK_PRIMARY		= 9,
		ACTION_ATTACK_SECONDARY		= 10,
		ACTION_ATTACK_RELOAD		= 11,
		ACTION_ATTACK_MELEE			= 12,

		// General
		ACTION_GENERAL_SCOREBOARD	= 13,
		ACTION_GENERAL_ESCAPE		= 14,
		ACTION_GENERAL_PING			= 15,

		// Debug action codes
		ACTION_CAM_ROT_UP			= 16,
		ACTION_CAM_ROT_DOWN			= 17,
		ACTION_CAM_ROT_LEFT			= 18,
		ACTION_CAM_ROT_RIGHT		= 19,
		ACTION_CAM_UP				= 20,
		ACTION_CAM_DOWN				= 21,
		ACTION_TOGGLE_MOUSE			= 22,
	};
	...
	*/
	inline const char* ActionToString(EAction action)
	{
		...
		case ACTION_MOVE_WALK:			return "ACTION_MOVE_WALK";
		...
		case ACTION_GENERAL_PING:		return "ACTION_GENERAL_PING";

		case ACTION_GENERAL_ESCAPE:		return "ACTION_ESCAPE";
	...
	inline const EAction StringToAction(const String& str)
	{
		static const THashTable<String, EAction> actionMap = {
			...
			{"ACTION_MOVE_WALK",			EAction::ACTION_MOVE_WALK},
			...
			{"ACTION_GENERAL_PING",			EAction::ACTION_GENERAL_PING},
			{"ACTION_ESCAPE",				EAction::ACTION_GENERAL_ESCAPE},
