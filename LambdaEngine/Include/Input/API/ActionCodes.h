...
namespace LambdaEngine
{
	...
	*/
	enum EAction : uint8
	{
		...
		ACTION_ATTACK_GRENADE		= 13,

		// General
		ACTION_GENERAL_SCOREBOARD	= 14,
		ACTION_GENERAL_ESCAPE		= 15,
		ACTION_GENERAL_PING			= 16,

		// Debug action codes
		ACTION_CAM_ROT_UP			= 17,
		ACTION_CAM_ROT_DOWN			= 18,
		ACTION_CAM_ROT_LEFT			= 19,
		ACTION_CAM_ROT_RIGHT		= 20,
		ACTION_CAM_UP				= 21,
		ACTION_CAM_DOWN				= 22,
		ACTION_TOGGLE_MOUSE			= 23,
	};
	...
	*/
	inline const char* ActionToString(EAction action)
	{
		...
		case ACTION_ATTACK_GRENADE:		return "ACTION_ATTACK_GRENADE";
	...
	inline const EAction StringToAction(const String& str)
	{
		static const THashTable<String, EAction> actionMap = {
			...
			{"ACTION_ATTACK_GRENADE",		EAction::ACTION_ATTACK_GRENADE},
