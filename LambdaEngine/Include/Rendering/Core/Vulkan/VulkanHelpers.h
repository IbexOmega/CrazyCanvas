...
namespace LambdaEngine
{
	...
	inline VkFormat ConvertFormat(EFormat format)
	{
		...
		case EFormat::FORMAT_B10G11R11_UFLOAT:		return VK_FORMAT_B10G11R11_UFLOAT_PACK32;
		...
		case EFormat::FORMAT_R16G16B16A16_SNORM:	return VK_FORMAT_R16G16B16A16_SNORM;
		case EFormat::FORMAT_R16G16B16A16_UNORM:	return VK_FORMAT_R16G16B16A16_UNORM;
		...
		case EFormat::FORMAT_R32G32_UINT:			return VK_FORMAT_R32G32_UINT;
		default:									return VK_FORMAT_UNDEFINED;
		}
	}

	inline VkCompareOp ConvertCompareOp(ECompareOp compareOp)
	{
		switch (compareOp)
		{
	...
	inline VkStencilOp ConvertStencilOp(EStencilOp stencilOp)
	{
		switch (stencilOp)
		{
		case EStencilOp::STENCIL_OP_KEEP:					return VK_STENCIL_OP_KEEP;
		case EStencilOp::STENCIL_OP_ZERO:					return VK_STENCIL_OP_ZERO;
		case EStencilOp::STENCIL_OP_REPLACE:				return VK_STENCIL_OP_REPLACE;
		case EStencilOp::STENCIL_OP_INCREMENT_AND_CLAMP:	return VK_STENCIL_OP_INCREMENT_AND_CLAMP;
		case EStencilOp::STENCIL_OP_DECREMENT_AND_CLAMP:	return VK_STENCIL_OP_DECREMENT_AND_CLAMP;
	...
	inline VkIndexType ConvertIndexType(EIndexType indexType)
	{
		switch (indexType)
		{
		case EIndexType::INDEX_TYPE_UINT16:		return VK_INDEX_TYPE_UINT16;
		case EIndexType::INDEX_TYPE_UINT32:		return VK_INDEX_TYPE_UINT32;
	...
	inline VkPrimitiveTopology ConvertPrimitiveToplogy(EPrimitiveTopology topology)
	{
		...
		case EPrimitiveTopology::PRIMITIVE_TOPOLOGY_PATCH_LIST:		return VK_PRIMITIVE_TOPOLOGY_PATCH_LIST;
	...
	inline VkVertexInputRate ConvertVertexInputRate(EVertexInputRate inputRate)
	{
		switch (inputRate)
		{
		case EVertexInputRate::VERTEX_INPUT_PER_VERTEX:		return VK_VERTEX_INPUT_RATE_VERTEX;
		case EVertexInputRate::VERTEX_INPUT_PER_INSTANCE:	return VK_VERTEX_INPUT_RATE_INSTANCE;
		case EVertexInputRate::VERTEX_INPUT_NONE:
		default:											return VK_VERTEX_INPUT_RATE_MAX_ENUM;
		}
	}

	inline VkStencilOpState ConvertStencilOpState(const StencilOpStateDesc& stencilOpStateDesc)
	{
		VkStencilOpState stencilOpState = { };
		stencilOpState.compareMask	= stencilOpStateDesc.CompareMask;
		stencilOpState.writeMask	= stencilOpStateDesc.WriteMask;
		stencilOpState.reference	= stencilOpStateDesc.Reference;
		stencilOpState.compareOp	= ConvertCompareOp(stencilOpStateDesc.CompareOp);
