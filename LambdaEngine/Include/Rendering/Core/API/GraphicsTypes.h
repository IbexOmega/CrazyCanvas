...
namespace LambdaEngine
{
	...
	*/
	...
	enum class EFormat : uint8
	{
		...
		FORMAT_R16G16_SNORM				= 5,
		
		FORMAT_R10G10B10A2_UNORM		= 6,

		FORMAT_R32G32_SFLOAT			= 7,

		FORMAT_B10G11R11_UFLOAT			= 8,
		
		FORMAT_R8G8B8A8_UNORM			= 9,
		FORMAT_B8G8R8A8_UNORM			= 10,
		FORMAT_R8G8B8A8_SNORM			= 11,
		
		FORMAT_R16G16B16A16_SFLOAT		= 12,
