...
namespace LambdaEngine
{
	...
	*/
	...
	enum class EFormat : uint8
	{
		...
		FORMAT_R32G32_SFLOAT			= 5,
		FORMAT_R11G11B10_UFLOAT			= 6,
		FORMAT_R8G8B8A8_UNORM			= 7,
		FORMAT_B8G8R8A8_UNORM			= 8,
		FORMAT_R8G8B8A8_SNORM			= 9,
		FORMAT_R16G16B16A16_SFLOAT		= 10,
		FORMAT_R32G32B32A32_SFLOAT		= 11,
		FORMAT_R32G32B32A32_UINT		= 12,
		FORMAT_D24_UNORM_S8_UINT		= 13,
	};
