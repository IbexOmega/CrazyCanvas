...
namespace LambdaEngine
{
	...
	public:
		...
		virtual void Render(Timestamp delta, uint32 modFrameIndex, uint32 backBufferIndex, CommandList** ppFirstExecutionStage, CommandList** ppSecondaryExecutionStage)	override final;
