...
namespace LambdaEngine
{
	...
	bool LevelObjectCreator::CreatePlayer(const void* pData, TArray<Entity>& createdEntities, TArray<uint64>& saltUIDs)
	{
		...
		CharacterColliderComponent characterColliderComponent = PhysicsSystem::GetInstance()->CreateCharacterCapsule(colliderInfo, std::max(0.0f, PLAYER_CAPSULE_HEIGHT - 2.0f * PLAYER_CAPSULE_RADIUS), PLAYER_CAPSULE_RADIUS);
