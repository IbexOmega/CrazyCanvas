...
namespace LambdaEngine
{
	...
	void ImGuiRenderer::Render(ICommandAllocator* pCommandAllocator, CommandList* pCommandList, uint32 modFrameIndex, uint32 backBufferIndex, CommandList** ppExecutionStage)
	{
